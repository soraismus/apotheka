...
/*
data Query a
  = GetUserDetails (Email -> (UserDetails, a))
  | Update (Email -> UserUpdate -> (UserDetails, a))

getUserDetails :: Monad m => Email -> m UserDetails
update :: Monad m => Email -> UserUpdate -> m UserDetails
*/

// DbioT m a ---> m (DBIO a)
// DbioT Query a ---> Query (DBIO a)
